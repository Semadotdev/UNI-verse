...
export function FolderAttachmentCard({ folder, onClick }: FolderAttachmentCardProps) {
  return (
    <div
      ...
      className="folder-attachment block w-full text-left rounded-xl border border-border bg-bg-raised overflow-hidden hover:border-primary/40 cursor-pointer transition-colors focus:outline-none focus:ring-2 focus:ring-primary/50"
